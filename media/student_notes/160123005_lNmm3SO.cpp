...
Ans::Ans(Ans *closest_pair_question ,Plane cartesion ,int n){
	distance=0;x1=0;y1=0;x2=0;y2=0;
	...
	distance=cartesion.Closest(&closest_pair_question,cartesion_xsorted,cartesion_ysorted,0,n-1,n);
	
}
double Ans::get_distance(){
	return distance;
}
void Ans::set_x1(double a){
	x1=a;
}
void Ans::set_y1(double b){
	y1=b;
}
void Ans::set_x2(double a){
	x2=a;
}
void Ans::set_y2(double b){
	y2=b;
}
double Ans::get_x1(){
	return x1;
...
int main(){
	...
	Ans closest_pair_question(&closest_pair_question,cartesion,n);
	cout<<closest_pair_question.get_distance();
	cout<<"raw"<<minimum<<"\n";
	return 0;
}
